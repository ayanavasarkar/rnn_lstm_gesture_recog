...
p1, =plt.plot( class1, time_step, label="MAXIMUM for Class =1", linewidth=5, marker='o', markeredgewidth= '5', markerfacecolor='black', color='b')
p2, =plt.plot( class2, time_step, label="MAXIMUM for Class =2", linewidth=5, marker='o', markeredgewidth= '5', markerfacecolor='black', color='r')
p3, =plt.plot( class3, time_step, label="MAXIMUM for Class =3", linewidth=5, marker='o', markeredgewidth= '5', markerfacecolor='black', color='g')
p4, =plt.plot( class4, time_step, label="MAXIMUM for Class =4", linewidth=5, marker='o', markeredgewidth= '5', markerfacecolor='black', color='y')
p5, =plt.plot( overall, time_step, label="MAXIMUM for all classes overall", linewidth=5, marker='o', markeredgewidth= '5', markerfacecolor='black', color='purple')

plt.grid()
plt.ylim([-45,0])
plt.xlim([0,40])
plt.xlabel('Maximums of the prediction arrays', **axis_font)
plt.ylabel('timesteps from 0 to 39', **axis_font)
...
plt.legend([ p1, p2, p3, p4, p5], [ "MAXIMUM for Class =1","MAXIMUM for Class =2", "MAXIMUM for Class =3",
           "MAXIMUM for Class =4", "MAXIMUM for all classes overall"], loc='lower center', fontsize = 24, borderaxespad=0.)	#
plt.show()
