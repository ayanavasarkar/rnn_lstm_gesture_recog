...
def RNN(x, weights, biases):
    ...
    # Defining a lstm cell with tensorflow
...
print pred
# Defining loss and optimizer (Adam optimizer most püreferable...need to check out others)
...
path='/home/admin/rnn_lstm_gesture_recog/data/'
path_t='/home/admin/rnn_lstm_gesture_recog/test.txt'
